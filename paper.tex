...
The resulting maze has 15 pins, 6 recursive boxes and 20 wires (with pins = wires + 1 - boxes).
...
$a_0 = 1$. The number of recursive boxes is the number of steps of the twisted
addition chain. The number of wires is two plus the total number of occurrences
of all constants in right-hand sides of the twisted addition chain..
...
\end{align*}
leads to a different maze with 8 recursive boxes, 12 pins and only 19
